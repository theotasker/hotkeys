...
SetBox()
{
	...
	Gui, Add, Text, x82 y80 w250 h70 +Center, Change Current Step
...
; shortcut to run the getnames function and get names from the edit page
f5::
{
...
; shortcut to call the review function and go to the review page
f6::
{
    global NeoDriver, currentstep, currentstepcss, currentstepxpath, ProgX, ProgY, StartStep, EndStep
    ...
    {       
        ...
        try NeoDriver.findElementByCss("#main-content-wrapper > div.page-content > div.content.ant-layout-content > div.card > div > div:nth-child(1) > button:nth-child(1)").Click()
        catch e 
        {
        ...
        currentstepcss := "#main-content-wrapper > div.page-content > div.content.ant-layout-content > div.card > div > div:nth-child(2) > div.ant-col-24 > button"
		currentstepxpath := "//*[@id=""main-content-wrapper""]/div[1]/div[2]/div[2]/div/div[2]/div[2]/button"
...
f8::
{
    ...
    WinWaitActive, New patient model set info|New patient info
...
; Insert the order ID from iTero into a new note on the edit page
Insert::
{
    global orderid, ProgX, ProgY
    ...
    try NeoDriver.findElementByCss("#main-content-wrapper > div > div.content.ant-layout-content > form > div.ant-row > div:nth-child(2) > div:nth-child(3) > div > div > div.ant-row-flex.ant-row-flex-end.editor__controls > div:nth-child(2) > button").Click()
    catch e
    {
        MsgBox couldn't click the save button
        Gui, Destroy
        return
    }
...
!+g::
{
	...
	IfMsgBox, Yes
	{
		...
		WinActivate, Virtual Base
		WinWaitActive, Virtual Base,, 10
...
^k::
{
	...
	try NeoDriver.findElementByXpath("//*[@id=""main-content-wrapper""]/div/div[2]/form/div[1]/div[1]/div[6]/div/div/div[2]/span/div[1]").Click()
	catch e
	{
