...
SetBox()
{
	...
	Gui, Font, underline
	Gui, Add, Text, cBlue gGuide x132 y120 w150 h20 +Center, Click here to view guide
...
f6::
{
	...
	{
		; xpath for managers
		currentstepxpath := "//*[@id=""main-content-wrapper""]/div[1]/div[2]/div[2]/div/div/div[2]/button[1]"
	}
...
Insert::
{
    global orderid, ProgX, ProgY, Step
