...
f7::
{
	...
	OrthoBatText := "pushd \\3sos2021\3Shape Ortho System\ScanItManager`nScanItManager.exe -SingleInstance=True -PatientInfoConversionType=Cmdline -PatientID=" clinic_under "_" firstname "_" lastname " -FirstName=" firstname " -LastName=" lastname " -Clinic=""" clinic """ -ModelSetID=" scriptnumber LowerModelBat UpperModelBat
