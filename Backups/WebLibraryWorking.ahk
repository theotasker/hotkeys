...
Neo_NavigateReviewFromEdit()
{
	...
	{
        try NeoDriver.findElementByCss(Path_ReviewButtonCSS).Click()
		catch e 
		{
...
Neo_GetInfoFromEdit()
{
    global NeoDriver, firstname, lastname, clinic, scriptnumber, Path_ScriptNumberCSS, Path_ClinicNameCSS
	Neo_StillOpen()
    ...
    if InStr(NeoDriver.Url, "https://portal.rxwizard.com/cases/edit/")
    {
        ...
        try
		{
			...
			clinic := NeoDriver.findElementByCss(Path_ClinicNameCSS).Attribute("title")
		}
		catch e
		{
